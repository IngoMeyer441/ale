...
call ale#Set('c_clangwin_target', 'amd64-pc-windows-msvc')
call ale#Set('c_clangwin_windows_options', '-Wno-unknown-pragmas -fms-compatibility-version=19 -U__clang__ -U__clang_version__ -U__clang_major__ -U__clang_minor__ -U__clang_patchlevel__ -U__llvm__')
...
function! ale_linters#c#clangwin#GetCommand(buffer) abort
    ...
    \   . ' -iquote %s:h'
    \   . ale#Pad(ale#Var(a:buffer, 'c_clangwin_options'))
    \   . ale#Pad(ale#Var(a:buffer, 'c_clangwin_windows_options'))
    \   . ' --target=' . ale#Var(a:buffer, 'c_clangwin_target')
